...
const imageLibrary = {
  ...
  vietnameseBlack: '/images/signature-collection/uploads-apr15/ca-phe-den.png',
  vietnameseMilk: '/images/signature-collection/uploads-apr15/ca-phe-sua.png',
  bacXiu: '/images/signature-collection/uploads-apr15/bac-xiu.png',
...
export const menuCategories = [
  ...
  },
  {
    ...
    items: [
      withDetails({ slug: 'espresso', name: 'Espresso', priceValue: 50000, category: 'Espresso Bar', image: imageLibrary.espresso, description: 'Two shots' }, { ingredientsKey: 'espresso', vi: 'Espresso là lựa chọn ngắn, đậm và trực diện nhất trong menu. Món này phù hợp với khách đã quen vị cà phê rõ và muốn cảm nhận profile hạt nhanh, gọn và tập trung.', en: 'Espresso is the shortest and most direct coffee choice on the menu. It suits guests who enjoy a clear coffee profile and want a focused tasting experience.' }),
