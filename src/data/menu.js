...
export const menuCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      withDetails({ slug: 'americano', name: 'Americano', priceValue: 55000, category: 'Espresso Bar', image: imageLibrary.espresso, description: 'Americano nhẹ hơn espresso nhưng vẫn giữ được tính cà phê rõ nét.' }, { ingredientsKey: 'americano', vi: 'Americano giữ được phần lõi của espresso nhưng dễ tiếp cận hơn nhờ kết cấu loãng và nhẹ hơn. Đây là lựa chọn phù hợp cho người thích cà phê đen theo hướng clean.', en: 'Americano keeps the core character of espresso while feeling lighter and easier to drink. It is a good choice for guests who like black coffee with a cleaner profile.' }),
  ...
  },
  {
    ...
    items: [
      withDetails({ slug: 'tra-vai', name: 'Trà Vải', priceValue: 60000, category: 'Tea', image: imageLibrary.fruitTea, description: 'Trà vải thơm và sáng, hợp khách thích đồ uống nhẹ nhàng.' }, { ingredientsKey: 'fruitTea', vi: 'Trà Vải có hương thơm rõ và độ ngọt dễ chịu, phù hợp với khách muốn một món nhẹ, thanh và dễ tiếp cận.', en: 'Trà Vải has a fragrant and easy sweetness, making it a good light and approachable choice.' }),
