...
## Pending business assets / confirmations
...
- Confirm all menu spellings and prices from the source menu
...
- Validate the current inferred bilingual ingredients/descriptions against the shop's real recipes
- Enrich each menu detail page with exact tasting notes, ingredient notes, allergen notes, and better photos
